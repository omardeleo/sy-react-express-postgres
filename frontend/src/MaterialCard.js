...
function MaterialCard(props) {
  ...
  return (
    <Card className={classes.card}>
      ...
      <p>
        ...
        <code>
          <Link
            ...
            href={`${process.env.REACT_APP_STARTER_REPO_URL}frontend/src/MaterialCard.js#L13`}
            target="_blank"
          >
      ...
      <pre>
        <code className="language-js">{codeBlock_3}</code>
      </pre>
      <p>with:</p>
      <pre>
        <code className="language-js">{codeBlock_4}</code>
      </pre>
      <p>
